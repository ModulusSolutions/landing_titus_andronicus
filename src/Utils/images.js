...
export const twoPerson = board
export const contactLogo = contact
export const clubsm = club
export const eventLogo = event
export const paymentLogo = payment
export const oneSideBoard = pana
export const flowerLogo = lg1
export const instagram = insta
export const circliLogo = circle
